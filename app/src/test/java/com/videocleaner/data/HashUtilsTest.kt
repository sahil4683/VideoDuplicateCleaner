...
class HashUtilsTest {
    ...
    fun `similarity of identical hashes is 100 percent`() {
        val hash = 0xDEADBEEFCAFEBABEUL.toLong()
    ...
    fun `hamming distance is symmetric`() {
        ...
        val hash2 = 0xFEDCBA9876543210UL.toLong()
    ...
    fun `similarity within 90 percent threshold for near identical hashes`() {
        ...
        val base = 0b1111111111111111111111111111111111111111111111111111111111111111UL.toLong()
